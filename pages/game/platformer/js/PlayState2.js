...
class PlayState2 extends Phaser.State {
    ...
    preload() {
        ...
        this.game.load.image('key', 'images/heart.png');
        // preload audio asset
    ...
    _onHeroVsDoor(hero, door) {
        ...
        this.game.add.tween(hero)
            .to({x: this.door.x, alpha: 0}, 3000, null, true)
